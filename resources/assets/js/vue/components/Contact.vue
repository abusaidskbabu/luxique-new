...
<section class="container mt-5">
   ...
   <div class="row">
        ...
        <div class="col-sm-12 col-md-7">
         <!--Google map-->
         <div class="mb-4">
            <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3652.8538910874227!2d90.3937000148605!3d23.7169111459721!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3755b930804c3fc3%3A0x3eca0b9966ce2bae!2sJumrat%20Tower%2C%20Urdu%20Road%2CChawk%20Bazar%20Dhaka!5e0!3m2!1sen!2sbd!4v1675837223026!5m2!1sen!2sbd" width="100%" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
          </div>
         <!--Buttons-->
         <div class="row text-center">
            <div class="col-md-4">
               <a class="site_bg px-3 py-2 rounded text-white mb-2 d-inline-block"><i class="fa fa-map-marker"></i></a>
               <p>{{ site_info.cnf_address }}</p>
            </div>
            <div class="col-md-4">
                <a class="site_bg px-3 py-2 rounded text-white mb-2 d-inline-block"><i class="fa fa-phone"></i></a></br>
...
export default {
	...
	mounted(){
        this.scrollToTop();
		document.title = "LuxiQue | Help-Center"; 
