        ...
        @if (Auth::user()->can('supplier.view'))
            <li class="nav-item parent_group">
                <a class="nav-link" data-toggle="collapse" href="#Supplier" aria-expanded="false" aria-controls="Supplier">
                    <i title="Supplier" class="menu-icon mdi mdi-account"></i>
                ...
                <div class="collapse" id="Supplier">
                    <ul class="nav flex-column sub-menu">
                        ...
                        @if (Auth::user()->can('supplier.view'))
                            <li class="nav-item"><a class="nav-link {{ Route::is('admin.supplier') || Route::is('admin.supplier.create') || Route::is('admin.supplier.edit') ? 'menu_active' : '' }}" href="{{ route('admin.supplier') }}"><i title="Suppliers" class="mdi mdi-cart menu_ico_small"></i> <span class="menu_title_small">Suppliers</span></a></li>
                        @endif

                        @if (Auth::user()->can('supplier.purchase.view'))
                            <li class="nav-item"><a class="nav-link {{ Route::is('admin.purchase') || Route::is('admin.purchase.create') || Route::is('admin.purchase.edit') ? 'menu_active' : '' }}" href="{{ route('admin.purchase') }}"><i title="Purchase" class="mdi mdi-cart menu_ico_small"></i> <span class="menu_title_small">Purchase</span></a></li>
                        @endif

                        @if (Auth::user()->can('supplier.purchase.return'))
                            <li class="nav-item"><a class="nav-link {{ Route::is('admin.purchase.return') || Route::is('admin.purchase.return.create') || Route::is('admin.purchase.return.edit') ? 'menu_active' : '' }}" href="{{ route('admin.purchase.return') }}"><i title="Purchase" class="mdi mdi-cart menu_ico_small"></i> <span class="menu_title_small">Supplier Return</span></a></li>
                        @endif
                    </ul>
                </div>
            </li>
            ...
            <li class="nav-item parent_group">
                ...
                <div class="collapse" id="Sales">
                    <ul class="nav flex-column sub-menu">
                        ...
                        @if (Auth::user()->can('order.invoice.view'))
                            <li class="nav-item">
                                <a class="nav-link {{ Route::is('admin.order.sold.invoice') ||  Route::is('admin.order.sold.invoice') ? 'menu_active' : '' }}"
                                    href="{{ route('admin.order.sold.invoice') }}">
                                    <i title="Sold Invoice" class="mdi mdi-cart menu_ico_small"></i> 
                                    <span class="menu_title_small">Sold Invoice</span>
                                </a>
                            </li>
                        @endif
                    </ul>
            ...
            <li class="nav-item parent_group">
                ...
                <div class="collapse" id="Accounting">
                    <ul class="nav flex-column sub-menu">
                        @if (Auth::user()->can('accounts.view'))
                            <li class="nav-item">
                                <a class="nav-link {{ Route::is('admin.accounts.dashboard') ? 'menu_active' : '' }}" href="{{ route('admin.accounts.dashboard') }}"><i title="Refund Request" class="mdi mdi-update menu_ico_small"></i> <span class="menu_title_small">Dashboard</span></a>
                            </li>
                        @endif

                        @if (Auth::user()->can('accounts.view'))
                            <li class="nav-item">
                                <a class="nav-link {{ Route::is('admin.accounts.assets') ? 'menu_active' : '' }}" href="{{ route('admin.accounts.assets') }}"><i title="Manage Accounts" class="mdi mdi-update menu_ico_small"></i> <span class="menu_title_small">Manage Accounts</span></a>
                            </li>
                        @endif

                        @if (Auth::user()->can('accounts.manage.customerdue'))
                            <li class="nav-item">
                                <a class="nav-link {{ Route::is('admin.accounts.customer.due') ? 'menu_active' : '' }}" href="{{ route('admin.accounts.customer.due') }}"><i title="Customer Due Received" class="mdi mdi-update menu_ico_small"></i> <span class="menu_title_small">Customer Due Received</span></a>
                            </li>
                        @endif

                        @if (Auth::user()->can('accounts.manage.paysupplier'))
                            <li class="nav-item">
                                <a class="nav-link {{ Route::is('admin.accounts.supplier.due') ? 'menu_active' : '' }}" href="{{ route('admin.accounts.supplier.due') }}"><i title="Payment Supplier" class="mdi mdi-update menu_ico_small"></i> <span class="menu_title_small">Payment Supplier</span></a>
                            </li>
                        @endif

                        @if (Auth::user()->can('accounts.manage.balancetransfer'))
                            <li class="nav-item">
                                <a class="nav-link {{ Route::is('admin.accounts.balance.transfer') ? 'menu_active' : '' }}" href="{{ route('admin.accounts.balance.transfer') }}"><i title="Contra / Balance Transfer" class="mdi mdi-update menu_ico_small"></i> <span class="menu_title_small">Contra / Balance Transfer</span></a>
                            </li>
                        @endif

                        @if (Auth::user()->can('accounts.manage.cashflow'))
                            <li class="nav-item">
                                <a class="nav-link {{ Route::is('admin.accounts.cashflow') ? 'menu_active' : '' }}" href="{{ route('admin.accounts.cashflow') }}"><i title="Cash Flow" class="mdi mdi-update menu_ico_small"></i> <span class="menu_title_small">Cash Flow</span></a>
                            </li>
                        @endif

                        @if (Auth::user()->can('accounts.manage.investor'))
                            <li class="nav-item">
                                <a class="nav-link {{ Route::is('admin.accounts.investor') ? 'menu_active' : '' }}" href="{{ route('admin.accounts.investor') }}"><i title="Manage Accounts" class="mdi mdi-update menu_ico_small"></i> <span class="menu_title_small">Manage Investor</span></a>
                            </li>
                        @endif

                        @if (Auth::user()->can('accounts.manage.loan'))
                            <li class="nav-item">
                                <a class="nav-link {{ Route::is('admin.accounts.loans') ? 'menu_active' : '' }}" href="{{ route('admin.accounts.loans') }}"><i title="Manage Accounts" class="mdi mdi-update menu_ico_small"></i> <span class="menu_title_small">Manage Loans</span></a>
                            </li>
                        @endif
        ...
        @if (Auth::user()->can('expense.view'))
            <li class="nav-item parent_group">
                <a class="nav-link" data-toggle="collapse" href="#Expense" aria-expanded="false" aria-controls="Expense">
                    <i class="menu-icon mdi mdi-currency-bdt"></i>
                ...
                <div class="collapse" id="Expense">
                    <ul class="nav flex-column sub-menu">
                        @if (Auth::user()->can('expense.view'))
                        <li class="nav-item">
                            <a class="nav-link {{ Route::is('admin.expense') || Route::is('admin.expense.create') || Route::is('admin.expense.edit') ? 'menu_active' : '' }}" href="{{ route('admin.expense') }}">
                                <i class="menu-icon mdi mdi-format-list-bulleted"></i>
                                <span class="menu-title">List</span>
                            </a>
                        </li>
                        ...
                        <li class="nav-item">
                            <a class="nav-link {{ Route::is('admin.expense.report') ? 'menu_active' : '' }}"
