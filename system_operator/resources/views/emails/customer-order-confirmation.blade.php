...
<div style="background:#76ad0c;width:750px;margin:0 auto;padding: 20px 0;color:#fff">
    <h2 style="text-align: center;text-transform: uppercase;font-size: 18px;">Thanks for your order!</h2>
    <p style="text-align:center">You'll receive an email when your items are shipped. If you have any questions, Call us -  {{\Helper::getsettings('phone_number')}}</p>
</div>
    
<section style="background:#f1f1f1;max-width:750px;margin:0 auto;padding: 20px 0px 0;">
                ...
                <div style="display: flex; -ms-flex-wrap: wrap;flex-wrap: wrap;padding: 0!important;">
                    <div  style="display: inline-block; margin-right: auto;">
                        <div style="font-size: 12px;padding-right: 0px;">
                            ...
                            <span style="font-weight: 600;">  Address: </span> {{$address->shipping_address}}, {{$shipping_union->title ?? ''}}, {{$shipping_thana->title ?? ''}},{{$shipping_district->title ?? ''}},{{$shipping_division->title ?? '' }} 
                            <br>
...
<table style="width: 650px;margin:30px auto">
  ...
  <table style="width: 650px;text-align:right; margin:50px auto">
     ...
     <p style="font-size:12px;text-align:center;background: #76ad0c;padding: 7px;color: #fff;">Thank you for being with us. Stay connected with <b><a target="_blank" hraf="https://kholabazaar.com.bd" style="color: #fff;text-decoration: none;">www.kholabazaar.com.bd</b> </p>
</section>
