...
class RolePermissionSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $permissions = [
            ...
            'supplier.purchase.products.ledger',
            ...
            'accounts.edit',
            'accounts.delete',
            'accounts.manage.assets',
            'accounts.manage.cashflow',
            'accounts.manage.investor',
            'accounts.manage.loan',
            'accounts.manage.investloan',
            'accounts.manage.customerdue',
            'accounts.manage.paysupplier',
            'accounts.manage.balancetransfer',
